...
function Skills () {
    ...
    const educations = [
        {
          name: "Cursanda em análise e desenvolvimento de sistemas | UniGoias",
        },
        {
          name: "Curso técnico em informática | CEAC",
        },
        {
            name: "Curso de front-end | Rocketseat",
        },
        {
            name: "Curso de github | Rocketseat",
        }
      ...
      <div className="container mx-auto max-w-4xl p-4 py-12">
        <div className="relative mb-4 p-4 text-center">
          <h2 className="relative z-50 mb-2 font-bold">
            ...
            <span className="font-handwriting text-4xl text-purple-800">
              Skills
            </span>
          </h2>
          ...
          <div className="absolute left-1/2 top-3 z-0  rounded-lg bg-blue-400/10" />
        </div>
        ...
        <div className="flex flex-col gap-8 md:flex-row">
          ...
          <div className="basis-1/2">
            <h3 className="mb-4 flex items-center gap-2 text-lg font-extrabold text-gray-700">
              <HiCodeBracketSquare className="h-8 w-8 text-purple-600" />
              Skills
            </h3>
