...
function Testimonials () {
    return (
      ...
      <figure>
        <FaQuoteLeft className="h-8 w-8 text-purple-600" />
        <blockquote className="mb-6">
          <p className="text-2xl text-gray-900 items-center">
            Yasmin me entregou o projeto no prazo.Recomendo o trabalho dele para
        ...
        <figcaption className="flex items-center justify-center gap-2">
          ...
          <div className="flex items-center divide-x-2 divide-gray-200">
            <div className="pr-3 font-medium text-gray-900 "> João </div>
